...
[filename_force,pathname_force]= uigetfile({'*.txt'},'Select force data');
[filename_disp,pathname_disp]= uigetfile({'*.txt'},'Select displacement data');

% Read from force and displacement output files
[time_force,value_force] = ReadDataLog([pathname_force,filename_force]);
[time_dis,value_dis] = ReadDataLog([pathname_disp,filename_disp]);
